...
def validate_profile_data(data: dict) -> str | None:
...
@sync_to_async
def get_random_profile(exclude_telegram_id: int) -> dict | None:
...
def get_profiles_list(
    exclude_telegram_id: int, exclude_list: list[int] | None = None
) -> list[dict]:
