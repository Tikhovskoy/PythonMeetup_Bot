...
from apps.events.models import (Event, Question, SendMessage, Speaker,
                                SpeakerTalk, UserProfile)
...
def test_question_without_speaker():
    event = Event.objects.create(title="Edge Meetup")
    speaker = Speaker.objects.create(name="Edge Спикер")
